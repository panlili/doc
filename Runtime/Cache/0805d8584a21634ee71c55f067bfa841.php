            ...
            <div class="page">
                ...
                <div id="nav">
                    ...
                    <div class="hlist">
                        ...
                        <ul>
                            <li class="active"><strong>用户组编辑</strong></li>
                ...
                <div id="main">
                    <form action="__URL__/update" method="POST">
                        <input name="g_id" type="hidden" value="<?php echo ($g_id); ?>"></input>
                        <p>用户组名：<input name="g_name" type="text" size="50" value="<?php echo ($g_name); ?>"></input></p>
                        <p>失效日期：<input name="fail_date" type="text" size="50" id="datepicker" value="<?php echo ($fail_date); ?>"></input></p>
                        <p>组的描述：</p><textarea style="margin-left: 55px;" name="g_content"  rows="10" cols="40"><?php echo ($content); ?></textarea>
                        <p>选择组的成员：</p>
                        <div style="border: 1px solid;padding: 15px;margin: 15px;">
                            <?php if(is_array($user_list)): $i = 0; $__LIST__ = $user_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="members[]" value="<?php echo ($vo["id"]); ?>" <?php if(isset($vo["checked"])): ?>checked=""<?php endif; ?>><?php echo ($vo["truename"]); ?> &nbsp;&nbsp;&nbsp;&nbsp;</input><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div> 
